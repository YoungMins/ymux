...
- **ネイティブブラウザペイン**: iframe の代わりに Tauri WebviewWindow を使用する
  ブラウザペイン。`X-Frame-Options` / CSP の制約なしであらゆるサイトを表示可能。
...
| **ydir** | `ydir` | mdir / Midnight Commander デュアルペインファイルマネージャー |
| **ycode** | `ycode <ファイル>` | VS Code スタイル TUI コードエディター（undo/redo、検索） |
