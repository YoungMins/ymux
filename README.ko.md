...
<p align="center">
  <img src="https://img.shields.io/badge/version-0.12.0-7fdbca?style=flat-square" alt="version 0.12.0" />
</p>
...
- **트레이로 닫기**: 창을 닫으면 ymux 가 트레이(Windows 알림 영역 / macOS
  메뉴 막대)로 숨고 셸과 에이전트는 계속 실행됩니다. 트레이 아이콘을 클릭하거나
  ymux 를 다시 실행하면 다시 열립니다(ymux 는 한 번에 하나만 실행됩니다). 종료는 트레이 메뉴의 **종료**, macOS 의 `Cmd+Q`, 또는 명령
  팔레트의 **ymux 종료** 로 하며,
