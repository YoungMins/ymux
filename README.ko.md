...
- **네이티브 브라우저 pane**: iframe 대신 Tauri WebviewWindow 를 사용하는
  브라우저 pane. `X-Frame-Options` / CSP 제약 없이 모든 사이트 로드 가능.
...
| **ydir** | `ydir` | mdir / Midnight Commander 듀얼 패널 파일 매니저 |
| **ycode** | `ycode <파일>` | VS Code 스타일 TUI 코드 에디터 (undo/redo, 검색) |
